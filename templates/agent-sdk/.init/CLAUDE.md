...
Two-tier memory system, both managed via file tools:

- **`MEMORY.md`** — Long-term knowledge, key decisions, learned preferences. Update when you learn something worth keeping permanently.
- **`memory/YYYY-MM-DD.md`** — Daily logs for session-level context. Update throughout the day as you work.
