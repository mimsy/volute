import * as discord from "./drivers/discord.js";
import * as slack from "./drivers/slack.js";
import * as telegram from "./drivers/telegram.js";
...
export function registerPlatform(name: string, platform: Platform): void {
