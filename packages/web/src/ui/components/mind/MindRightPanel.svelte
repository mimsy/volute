...
<div class="mind-panel">
  {#if onChat || onExpand}
    <div class="floating-btns">
      {#if onChat}
        <button class="floating-btn" onclick={onChat} use:tooltip={{ text: "Chat", position: "right" }} aria-label="Chat">
      ...
      {/if}
      {#if onExpand}
        <button class="floating-btn" onclick={onExpand} use:tooltip={{ text: "Expand", position: "right" }} aria-label="Expand">
